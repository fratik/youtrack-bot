...
package pl.fratik.youtrackbot.util;
...
public class NetworkUtil {
    ...
    private static final OkHttpClient clientNoRedirect = new OkHttpClient.Builder().followRedirects(false).build();
    ...
    public static Response headRequestNoRedirect(String url) throws IOException {
        return clientNoRedirect.newCall(new Request.Builder().head().header(UA, USER_AGENT).url(url).build()).execute();
    }
    ...
    public static JSONResponseObject getJson(String url) throws IOException {
